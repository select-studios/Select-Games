    ...
    <>
      ...
      >
        <div className="mx-5 flex h-16 max-w-screen-xl items-center justify-between xl:mx-auto">
          ...
          <div>
            <button className="p-1.5 px-4 text-sm text-black transition-all">
            ...
            <button className="rounded-full border border-black bg-black p-1.5 px-4 text-sm text-white transition-all hover:bg-white hover:text-black">
              <a href="https://github.com/select-studios/Select-Launcher/releases/download/v1.3.7/Select-Launcher-Windows-1.3.7-Setup.exe">
                Download
              </a>
            </button>
          </div>
